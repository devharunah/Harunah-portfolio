    ...
    return(
       <div  className="mt-10"  >
        <div className="flex justify-center"  >
            ...
            <div  className=" shadow-lg bg-blue-50 py-10 flex justify-center items-center flex-col px-10 sm:py-auto w-full h-auto rounded-md "  >
                  <div className='mb-4   '   >
                    <div className='w-14'  >
                ...
                <div  className=" shadow-lg bg-blue-50 flex justify-center py-10 px-10 items-center flex-col  w-full h-auto"  >
                ...
                <div  className=" shadow-lg bg-blue-50 flex justify-center items-center flex-col w-full h-auto px-10 py-10"  >
                  <div  className='mb-4 w-15  '  >
                ...
                <div  className=" shadow-lg flex justify-center items-center flex-col  w-full h-auto bg-blue-50 py-10 px-10"  >
                  <div className='mb-4 w-15' >
